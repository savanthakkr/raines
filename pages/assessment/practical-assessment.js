...
import PracticalAssessmentInstruction from "@/components/Assessment/PracticalAssessmentInstruction";

export default function PracticalAssessment({ user }) {
    ...
    return (
        <>
            ...
            <PracticalAssessmentInstruction />
