...
import InstructorCheckoutForm from "@/components/Business/Checkout/BusinessCheckoutForm";
...
export default function InstructorCheckoutPage({ user }) {
	return (
		<>
			<BusinessNav user={user} />
			...
			<PageBanner
				...
				imageUrl="/images/breadcrumb/checkOutBreadcrumb.jpg"
			/>

			<InstructorCheckoutForm course={course}/>
