...
import CourseEnrolmentForm from "@/components/SingleCourses/CourseEnrolmentForm";
	...
	return (
		<>
			...
			<PageBanner
				...
				imageUrl="/images/breadcrumb/enrollmentFormBreadcrumb.jpg"
			/>

			{course && <CourseEnrolmentForm user={user} course={course} />}
