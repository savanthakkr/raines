...
export default function ManageEmployeesTab() {
    ...
    useEffect(() => {
        if (router.pathname === '/business/employees/manage-employees') {
            setActiveTab('Users');
        } else if (router.pathname === '/business/employees/manage-users') {
            setActiveTab('Manage');
        } else if (router.pathname === '/business/employees/report') {
    ...
    const handleTabChange = (tab) => {
        setActiveTab(tab);
        if (tab === 'Users') {
            router.push('/business/employees/manage-employees');
        } else if (tab === 'Manage') {
            router.push('/business/employees/manage-users');
        } else if (tab === 'Reports') {
            router.push('/business/employees/report');
        }
    };
                            ...
                            <tr key={idx} className="border-t">
                                ...
                                <td className="p-3 text-center action position-relative dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li>
                                            <Link href="/business/employees/personal-details">
                        ...
                        {reports.map((user, idx) => (
                            <tr key={idx} className="border-t">
                                ...
                                <td className="p-3 text-center action position-relative dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li>
                                            <Link href="/business/employees/course-report/">
