...
const InstructorCheckoutDetailsSidebar = ({ course }) => {
    const {
        slug,
        title,
        short_desc,
    ...
    return (
        <>
            ...
            <div className="checkout-section">
                ...
                <a href="/instructor/courses/instructor-my-course/" className="default-btn w-100 mt-3">Checkout Now<span></span></a>
            </div>
        </>
    );
};

export default InstructorCheckoutDetailsSidebar;